...
1. [**Reflexive validation**](competance_without_trust_glossary.md#reflexive-validation), or the active assessment of a source’s trustworthiness  
2. [**Authenticity as a filtering mechanism**](competance_without_trust_glossary.md#authenticity-filtering), in which perceived coherence or usefulness outweighs formal correctness  
3. [**Emergent competence**](competance_without_trust_glossary.md#emergent-competence), the development of usable skill through iteration rather than certainty
...
[Read the original article: *Learning in Reverse*](../learning_in_reverse.md)
