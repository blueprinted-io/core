...
software_version: The version of the software this content was written for, exactly as it appears in the source document — in headers, titles, footers, or version declarations. If the document covers a specific release (e.g. "6.1", "22.04 LTS", "v3.2.1"), extract it. null if the document does not state a version.
...
software_version: The version of the software this content was written for, exactly as it appears in the source document. null if the document does not state a version.
...
Return JSON with this structure: {"tasks":[{"id":"T001","title":"...","outcome":"...","software_version":null,"procedure_name":"...","facts":[],"concepts":[],"dependencies":[],"irreversible":false,"steps":[{"text":"...","completion":"...","actions":[],"notes":null}]}],"workflows":[{"title":"...","objective":"...","task_order":["T001","T002"]}]}"""
